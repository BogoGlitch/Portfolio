...
// UpdateSkillValidator uses identical rules to CreateSkillValidator.
...
{
    private readonly UpdateSkillValidator _validator = new();

    private static UpdateSkillDto ValidDto(
        string name = "React",
        string slug = "react",
